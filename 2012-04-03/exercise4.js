...
function drawTable(){
	var leg = SIMPLEX_GRID([ [0.1],[0.1],[-floorHeight,1] ]);
	var surface = SIMPLEX_GRID([ [6],[2],[-floorHeight-1,0.08] ]);
	return STRUCT([surface,T([0,1])([1,1])(leg),T([0,1])([3,1])(leg),T([0,1])([5,1])(leg)]);
}

var table1 = drawTable();
var table2 = R(2)(PI/2)(drawTable());
COLOR([102/255,51/255,0])(table1);
COLOR([102/255,51/255,0])(table2);

table1 = T([0,1])([13,11])(table1);
table2 = T([0,1])([24,2])(table2);

drawBuilding([columns,bench,wall,steps,floor,roof,pool1Water,pool2Water,table1,table2]);